...
type Alice interface {
	// GenerateKeys generates Alice's judecoin public spend and view keys (S_b, V_b)
	GenerateKeys() error
...
func NewAlice(judecoinEndpoint, ethEndpoint, ethPrivKey string, t0, t1 time.Time) (*alice, error) {
