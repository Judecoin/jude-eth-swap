...
const (
	defaultAliceJudecoinEndpoint = "http://127.0.0.1:16063/json_rpc"
	defaultBobJudecoinEndpoint   = "http://127.0.0.1:16060/json_rpc"
...
func runBob(c *cli.Context, amount uint) error {
	...
	bob, err := bob.NewBob(judecoinEndpoint, ethEndpoint, ethPrivKey)
	if err != nil {
		return err
	}
