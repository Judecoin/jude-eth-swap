...
// curl -X POST http://127.0.0.1:16061/json_rpc -d '{"jsonrpc":"2.0","id":"0","method":"generateblocks","params":{ "wallet_address":"JBAo6em...","amount_of_blocks":100000}}' -H 'Content-Type: application/json'
...
func TestClient_Transfer(t *testing.T) {
	...
	// `./judecoin-wallet-rpc  --stagenet --rpc-bind-port 16062 --password "" --disable-rpc-login --wallet-dir .`
